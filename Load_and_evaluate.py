...
#   Load models
# ----------------------------
ENCODE_PATH = './.save/encoder_75000.pt'
DECODER_PATH = './.save/decoder_75000.pt'

""" # FIXME : wrong way to load model
encoder_model = torch.load(ENCODE_PATH)
print('encoder model : ', encoder_model)

decoder_model = torch.load(DECODER_PATH)
print('decoder model : ', decoder_model)
"""
