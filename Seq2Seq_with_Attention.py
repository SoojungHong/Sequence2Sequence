...
def readLangs(lang1, lang2, reverse=False):
    ...
    lines = open('data/%s-%s.txt' % (lang1, lang2), encoding='utf-8').read().strip().split('\n')    #ToDo : how line looks like before split

    # Split every line into pairs and normalize
    pairs = [[normalizeString(s) for s in l.split('\t')] for l in lines]    #ToDo : how line looks like before split
...
# ----------------------------------------------------------------------------------------------------------
# we want to train something quickly, we’ll trim the data set to only relatively short and simple sentences.
...
# training model
#
# comment : “Teacher forcing” is the concept of using the real target outputs as each next input, instead of using the decoder’s guess as the next input.
